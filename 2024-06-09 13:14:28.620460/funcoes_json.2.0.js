...
function carregaPais(){pais=$("#paisPrevisao").val();estado="";municipio="";litoral=0;$('#container-previsao').slideUp(1000);$("#estadoPrevisao").hide(500).empty();$("#municipio_seletor_previsao span").empty();$("#municipio_seletor_previsao .select-form").hide();$("#municipioPrevisao").hide(500).empty();$("#praia_seletor_previsao span").empty();$("#praia_seletor_previsao .select-form").hide();$("#praiaPrevisao").hide(500).empty();$("#oito_dias_previsao").hide(500);leJsonEstado();}
